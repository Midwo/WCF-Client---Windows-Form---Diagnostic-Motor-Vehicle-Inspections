...
{
    public partial class InvoicePers : Form
    {
        private class Item
        {
            public string Name;
        ...
        private void printDocument2_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Facture individual - personal", new Font("Arial", 12, FontStyle.Regular), Brushes.Black, new Point(25, 240));
        ...
        {
            if (textBox1.Text.Trim() != string.Empty & textBox4.Text.Trim() != string.Empty)
            {
